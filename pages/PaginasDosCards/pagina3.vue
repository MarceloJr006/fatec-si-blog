<template>
    <div>
        <div class="containerpag3">
            ...
            <div class="textops5pag3">
                <p>
                    PlayStation 5, novo console da Sony, tem pré-venda iniciada nesta quinta-feira (17). Games exclusivos terão preços sugeridos entre R$ 250 e R$ 350.
...
No evento, a empresa ainda anunciou games novos do console, como "Hogwarts Legacy", "Final Fantasy XVI" e uma nova história de "God of War", que deve ser focada no Ragnarok.
            ...
            <div class="atorps5pag3">
                <b><p>Por G1 16/09/2020 18h07 </p></b>
            </div>
        </div>
    </div>
</template>
